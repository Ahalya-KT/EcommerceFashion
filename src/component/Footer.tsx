...
function Footer() {
  return (
    <div className="">
      <div className="flex w-full   px-28 bg-blue-gray-50 py-5 ">
        <div className="w-72">
        ...
        <div className="w-72">
          ...
          <input type="text" placeholder="Enter Email" className=" border-b border-gray-800 my-8 bg-blue-gray-50 text-sm w-72 p-4" />
        </div>
